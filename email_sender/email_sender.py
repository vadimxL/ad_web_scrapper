...
class EmailSender:
    def __init__(self, recipient: str, log_only=False) -> None:
    ...
    def send(self, msg_content: str, subject: str = "Automated draft"):
        ...
        if self.log_only:
            logger.info(f"Message sent!, check your inbox for the email.")
            return
        ...
        logger.info("Message sent!, check your inbox for the email.")
...
if __name__ == "__main__":
    ...
    car_details = AdDetails(id="123456", manuf_en="Toyota", manuf_he="טויוטה", car_model="Corolla", year="2019", price="100000", prices=[],
